...
class Collider(Component):
    ...
    def __init__(
        ...
        one_way_collision_direction_x: float = 0.0,
    ) -> None:
        """
        ...
        self.one_way_collision_direction_x: float = float(one_way_collision_direction_x)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "one_way_collision_direction_x": self.one_way_collision_direction_x,
        }
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Collider":
        ...
        component = cls(
            ...
            one_way_collision_direction_x=data.get("one_way_collision_direction_x", 0.0),
        )
