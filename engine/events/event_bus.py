...
PROPÓSITO:
    Sistema de eventos publish-subscribe para comunicación
...
EVENTOS PREDEFINIDOS:
    ...
    - on_animation_end: Cuando una animación termina
...
class EventBus:
    """
    Bus central de eventos con patrón publish-subscribe.
    ...
    def get_recent_events(self, count: int = 10) -> List[Event]:
        ...
        Args:
            count: Número de eventos a obtener
    ...
    def get_subscriber_count(self, event_name: str) -> int:
        """Obtiene el número de suscriptores a un evento."""
