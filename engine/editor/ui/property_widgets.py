...
CommitContract = Callable[[str, str, Any, Any], PropertyEditResult | bool | None]
...
class EditTransaction:
    ...
    def set_value(self, group_name: str, prop_name: str, value: Any) -> None:
    ...
    def get_value(self, group_name: str, prop_name: str, default: Any = None) -> Any:
    ...
    def _original_value(self, group_name: str, prop_name: str) -> Any:
    ...
    def _iter_dirty_snapshot(self) -> list[tuple[str, str, Any, Any]]:
        return [
    ...
    def _call_commit_callback(
        self, group_name: str, prop_name: str, old_value: Any, new_value: Any
    ) -> PropertyEditResult:
