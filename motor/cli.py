...
Documentation:
  ...
  - See docs/cli.md for the official CLI reference
    ...
    physics_query_shape_cast_parser = physics_query_subparsers.add_parser(
        "shape_cast",
        help="Query physics shape cast",
    )
    physics_query_shape_cast_parser.add_argument("shape_type", type=str, help="Shape type: box, circle, capsule")
    physics_query_shape_cast_parser.add_argument("shape_width", type=float, help="Shape width")
    physics_query_shape_cast_parser.add_argument("shape_height", type=float, help="Shape height")
    physics_query_shape_cast_parser.add_argument("origin_x", type=float, help="Cast origin X")
    physics_query_shape_cast_parser.add_argument("origin_y", type=float, help="Cast origin Y")
    physics_query_shape_cast_parser.add_argument("direction_x", type=float, help="Cast direction X")
    physics_query_shape_cast_parser.add_argument("direction_y", type=float, help="Cast direction Y")
...
def dispatch_command(parsed: argparse.Namespace) -> int:
    ...
    # === physics ===
        ...
        elif parsed.physics_subcommand == "query" and parsed.physics_query_subcommand == "shape_cast":
            return cmd_physics_shape_cast(
                project_path=Path(parsed.project_root).resolve(),
