"""
tools/introspect.py - Herramienta de reflexión para inspeccionar el motor

PROPÓSITO:
    Permite a la IA inspeccionar el estado del motor en tiempo de ejecución.
    Equivalente a una "consola de reflexión" donde la IA puede ejecutar
...
def inspect_entity(world: World, entity_name: str) -> Dict[str, Any]:
    ...
    Returns:
        Diccionario con toda la información de la entidad:
        {
            "name": "Player",
            "id": 0,
            "components": {
    ...
    for component in entity.get_all_components():
        ...
        # Intentar serialización completa
        if hasattr(component, 'to_dict'):
            ...
            # Fallback: introspección de atributos
            attrs = {}
...
def list_systems() -> List[Dict[str, str]]:
    ...
    for filename in sorted(os.listdir(systems_dir)):
        ...
        # Leer primera línea de docstring si existe
        description = ""
        try:
