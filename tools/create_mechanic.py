"""
tools/create_mechanic.py - Herramienta IA para crear mecánicas de juego

PROPÓSITO:
    Permite a la IA crear automáticamente nuevos Systems en el motor.
    La IA ejecuta esta herramienta cuando el usuario dice cosas como
    "Añade una mecánica de doble salto" o "Crea un sistema de inventario".

FUNCIONALIDAD:
    - Genera un archivo de System con boilerplate ECS correcto
    - Lo registra en engine/systems/__init__.py
    - Genera código listo para ser conectado en main.py
...
def create_game_mechanic(
    ...
    Args:
        name: Nombre de la mecánica (snake_case, ej: "double_jump")
        description: Descripción de lo que hace el sistema
...
class {class_name}:
    ...
    def update(self, world: World, delta_time: float) -> None:
        """
        Actualiza la lógica del sistema.
...
'''
    ...
    # Añadir obtención de cada componente
    for comp in required_components:
        var_name = comp.lower()
    ...
    code += f"""
            ...
            # TODO: Implementar lógica de {name.replace('_', ' ')} aquí
            pass
"""
    ...
    print(f"[CREATE_MECHANIC] Para usarlo, añade en main.py:")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Uso: python tools/create_mechanic.py <nombre> [descripción] [comp1,comp2,...]")
